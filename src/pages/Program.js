      ...
      <div className="Session">
        <div className="basicContainer">
          ...
          <text className="smallText">
            E-COPS의 정규 세션은 Beginner Track과 Challenger Track으로 나누어서
            이루어집니다.
            <br />
            자유롭게 선택해 보세요.
          </text>
          <div className="box_grid">
            <div className="whiteBox">
              <img
                className="program_beginner_img"
                src={program_beginner_img}
              />
              <button
                className="button1"
                onClick={() => {
            ...
            <div className="grayBox">
              <img
                className="program_challenger_img"
                src={program_challenger_img}
              />
              <button
                className="button2"
                onClick={() => {
